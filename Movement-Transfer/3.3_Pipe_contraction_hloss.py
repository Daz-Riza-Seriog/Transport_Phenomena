...
Params = Paramters()
V_avg_1 = Params.Velocity(5.666e-3, 0.2)
V_avg_2 = Params.Velocity(5.666e-3, 0.12)

H_loss_M = Head_Loss_Major()
h_l_1_M = H_loss_M.h_l(sol1.x[0], 400, 0.2, V_avg_1, 9.82)
h_l_2_M = H_loss_M.h_l(sol2.x[0], 800, 0.12, V_avg_2, 9.82)
h_l_t_M = h_l_1_M + h_l_2_M

H_loss_m = Head_Loss_Minor()
h_l_1_m = H_loss_m.h_l(0.12, V_avg_1, 9.82)
h_l_2_m = H_loss_m.h_l(0.12, V_avg_2, 9.82)
h_l_t_m = h_l_1_m + h_l_2_m

h_l_t = h_l_t_M+h_l_t_m
...
print("\nHead Loss Major for second part:\t", h_l_2_M)
print("\nHead Loss Major total:\t", h_l_t_M)
print("\nHead loss Minor for first part:\t", h_l_1_m)
print("\nHead Loss Minor for second part:\t", h_l_2_m)
print("\nHead Loss Minor total:\t", h_l_t_m)
print("\nHead Loss total:\t", h_l_t)
